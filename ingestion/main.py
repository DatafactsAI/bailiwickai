...
def process_fact_find_pdf(pdf_path: str) -> dict:
    """
    Process a fact find PDF file and return the processed payload.
    
    Args:
        pdf_path: Path to the PDF file to process
        
    Returns:
        dict: Processed payload dictionary ready to be sent to webhook
...
def main():
    ...
    try:
        # Process the PDF
        payload_dict = process_fact_find_pdf(args.pdf_path)
